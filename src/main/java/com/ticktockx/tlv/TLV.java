...
public class TLV
{
	...
	/// <summary>
	///     The raw com.ticktockx.TLV data.
	/// </summary>
	public byte[] Data;
	...
	/// <summary>
	///     The length of the com.ticktockx.TLV value.
	/// </summary>
	public int Length =0 ;
	...
	/// <summary>
	///     com.ticktockx.TLV children.
	/// </summary>
	public Collection<TLV> Children ;

	/// <summary>
	///     Parse com.ticktockx.TLV data.
	/// </summary>
	/// <param name="tlv">The hex com.ticktockx.TLV blob.</param>
	...
	///     Parse com.ticktockx.TLV data.
	/// </summary>
	/// <param name="tlv">The byte array com.ticktockx.TLV blob.</param>
	/// <returns>A collection of TLVs.</returns>
